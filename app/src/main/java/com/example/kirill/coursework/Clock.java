...
class Clock extends Thread {
    ...
    public Clock(Activity activity) {
        ...
        first = (ImageView) activity.findViewById(R.id.first_t);
        second = (ImageView) activity.findViewById(R.id.second_t);
        third = (ImageView) activity.findViewById(R.id.third_t);
